            ...
            <div class="row mb-3">
                ...
                <div class="col-md-6">
                    <input id="code" disabled type="text" class="form-control @error('code') is-invalid @enderror"
                        name="code" value="{{ $service->code ?? old('code') }}" autocomplete="code" autofocus>
            ...
            <div class="row mb-3">
                ...
                <div class="col-md-6">
                    <input id="name" type="text" class="form-control @error('name') is-invalid @enderror"
                        name="name" value="{{ $service->name ?? old('name') }}" autocomplete="name" autofocus>
            ...
            <div class="row mb-3">
                ...
                <div class="col-md-6">
                    <input id="price" type="price" class="form-control @error('price') is-invalid @enderror"
                        name="price" value="{{ $service->price ?? old('price') }}" autocomplete="price">
            ...
            <div class="row mb-3">
                ...
                <div class="col-md-6">
                    <textarea role="5" id="description" type="text" class="form-control @error('description') is-invalid @enderror"
                        name="description" autocomplete="description">{{ $service->description ?? old('description') }}</textarea>
                </div>
            </div>
